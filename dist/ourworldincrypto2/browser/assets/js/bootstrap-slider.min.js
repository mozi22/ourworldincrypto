    ...
    return function(a) {
        ...
        function(a) {
            ...
            d = function(a, b) { return e.call(this, a, b), this }, d.prototype = {
                ...
                _showTooltip: function() { this.options.tooltip_split === !1 ? (this._addClass(this.tooltip, "show"), this.tooltip_min.style.display = "none", this.tooltip_max.style.display = "none") : (this._addClass(this.tooltip_min, "show"), this._addClass(this.tooltip_max, "show"), this.tooltip.style.display = "none"), this._state.over = !0 },
                _hideTooltip: function() { this._state.inDrag === !1 && this._alwaysShowTooltip !== !0 && (this._removeClass(this.tooltip, "show"), this._removeClass(this.tooltip_min, "show"), this._removeClass(this.tooltip_max, "show")), this._state.over = !1 },
                ...
                _setTooltipPosition: function() {
                    ...
                    if ("vertical" === this.options.orientation) {
                        ...
                        a.forEach(function(a) { this._addClass(a, "bs-tooltip-" + b), a.style[c] = "100%" }.bind(this))
                    } else "bottom" === this.options.tooltip_position ? a.forEach(function(a) { this._addClass(a, "bs-tooltip-bottom"), a.style.top = "22px" }.bind(this)) : a.forEach(function(a) { this._addClass(a, "bs-tooltip-top"), a.style.top = -this.tooltip.outerHeight - 14 + "px" }.bind(this))
                },
